...
> [!IMPORTANT]
> **Git Commit & Push Policy**: NEVER run `git commit` or `git push` automatically. Keep all changes in the working tree. Commit and push ONLY when explicitly requested by the user.
